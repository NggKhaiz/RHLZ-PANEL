...
export const SettingsProvider = ({ children }: { children: React.ReactNode }) => {
  const [panelName, setPanelName] = useState<string>(PANEL_UI_NAME);
  ...
  const [theme, setTheme] = useState<string>("rhlz");
  ...
  const fetchSettings = async () => {
    try {
      ...
      if (res.data.theme !== undefined) {
        ...
        document.documentElement.setAttribute("data-theme", "rhlz");
      }
    } catch (e) {}
  };
